...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a target="_blank" href="https://wa.me/2348103171902" class="nav-link">Portal Help</a>
                </li>
            </ul>
        </nav>
        <!-- /.navbar -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/logo.png" alt="Daglore Model School" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">Daglore Staff Portal</span>
            </a>
 ...
 while($row= mysqli_fetch_array($result_set))
 {
  ?>
                            <?php echo'
          <img style="width: 60px" src="https://admin.dagloremodelschool.com.ng/upload/staffDP/'.$row['passport'].'" class="img-circle elevation-2" alt="Profile Picture">';
          ?>
                        </div>
                        <div class="info">
...
?>
   ...
   $pass = str_replace('/', '', $data);
 {
  ?>
                                    <li class="nav-item">
                                        <?php echo '
                <a target="_blank" href="https://admin.dagloremodelschool.com.ng/upload/employ/'.$pass.'.pdf" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Employment Letter</p>
                </a>
              </li>
              <li class="nav-item">
                <a target="_blank" href="https://admin.dagloremodelschool.com.ng/upload/StaffId/'.$pass.'.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Staff ID Card</p>
                </a>
              </li>';
