                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="form-group col-md-2">
                                    <label for="exampleInputEmail1">1st Test(15) .:</label>
                                    <input type="number" name="date" id="test" placeholder="1st Test(15)"
                                        class="form-control">
                                </div>
                                <!-- /.input group -->
                                <div class="form-group col-md-3">
                                    <label for="exampleInputEmail1">2nd Test(15).:</label>
                                    <input type="number" name="month" id="ass" placeholder="2nd Test(15)"
                                        class="form-control">
                                </div>
                                <!-- /.input group -->
                                <div class="form-group col-md-3">
                                    <label for="exampleInputEmail1">Assignment(10).:</label>
                                    <input type="number" name="year" id="exc" placeholder="Assignment(10)"
                                        class="form-control">
                                </div>
                                <!-- /.input group -->
                                <div class="form-group col-md-2">
