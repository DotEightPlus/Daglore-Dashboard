          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $row['surname']." ".$row['firstname']; ?></h3>
                <p class="text-center"><small>Qualification.: <?php echo $row['qual'] ?></small></p>
                <a style="color: red;" href="./staffedit?id=<?php echo $data ?>"><p class=" text-center">Edit Profile</p></a>
                <b><p class="text-muted text-center">Admission No.: <?php echo $row['staffid']; ?></p></b>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Bio Details</a></li>
                  <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Portal Details</a></li>
                    ...
                    <div class="timeline timeline-inverse">
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          ...
                          <div class="timeline-footer">
                            <a target="_blank" href="./atcard?id=<?php echo $data ?>" class="btn btn-warning btn-flat btn-sm">Print ID Card</a>
                          </div>
