    ...
    <div class="pt-4">
        <div style="width: 227px; background-color: gold;" class="card">
            <div class="card-header text-center border-bottom-0">
                ...
                <h2 style="font-size: 10px;"><b>DAGLORE MODEL SCHOOL</b><br />
                    <small style="font-size: 8px;">Ikole-Ekiti, Ekiti State.</small>
                    <small style="font-size: 8px;">&nbsp;&nbsp; Tel: 08036105151</small>
                </h2>
            </div>
        ...
        <div style="width: 227px; background-color: black;" class="card">
            <div class="row">
                <div class="col-14 pt-3">
                    ...
                    <div class="card-header text-center pt-0">
                        <img src="dist/img/favicon2.ico" width="20px" height="20px">
                        <h2 style="font-size: 14px; color: white"><b>DAGLORE MODEL SCHOOL</b><br />
                            <small style="font-size: 10px;">Ikole-Ekiti, Ekiti State.</small>
                            <small style="font-size: 10px;">&nbsp;Tel: 08036105151</small>
                            <small style="font-size: 8px;">&nbsp;Website: https://dagloremodelschool.com.ng</small>
                        </h2>
                    </div>
            ...
            <div class="card-footer pr-0 pl-0 pb-0 mt-0">
                <div class="text-center pt-3">
                    <p style="background-color: gold; font-size: 14px"><i>Daglore Schools... Academic Excellence!
                        </i></p>
